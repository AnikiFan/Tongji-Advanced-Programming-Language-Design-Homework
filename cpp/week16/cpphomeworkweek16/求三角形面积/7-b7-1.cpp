...
public:
	...
	double area()
	{
		if (fabs(p2.getx() * p3.gety() - p2.gety() * p3.getx() - (p1.getx() * p3.gety() - p1.gety() * p3.getx()) + p1.getx() * p2.gety() - p1.gety() * p2.getx()))
			return 0.5 * fabs(p2.getx() * p3.gety() - p2.gety() * p3.getx() - (p1.getx() * p3.gety() - p1.gety() * p3.getx()) + p1.getx() * p2.gety() - p1.gety() * p2.getx());
		else
			return -1;
	}
	/* 构造函数 */
